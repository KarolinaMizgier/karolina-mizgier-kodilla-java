...
class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("Test List of Books with conditions")
    class testListBooksWithConditions {
        @Test
            // [1]
        void testCorrectReturnList() {                                      // [2]
        ...
        @Test
        void testWhenConditionFragmentShorterThan3() {                          // [1]
            // Given
    ...
    @Nested
    @DisplayName("Test List of books in hands of user")
    class testListBooksInHandsOf {
        @Test
        void testWhenUserHasNoBooks() {
            //Given
            ...
            //When
            List<Book> listBooksOfUser = bookLibrary.listBooksInHandsOf(user);
            //Then
            Assertions.assertEquals(0, listBooksOfUser.size());
        }

        @Test
        void testWhenUserHasOneBook() {
            //Given
            LibraryUser user = new LibraryUser("Adam", "Nowak", 890405768);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            ...
            List<Book> listBooksOfUser = bookLibrary.listBooksInHandsOf(user);
            //Then
            Assertions.assertEquals(1, listBooksOfUser.size());
        }
        ...
        void whenUserHas5Books() {
            ...
            LibraryUser user = new LibraryUser("Adam", "Nowak", 890405768);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> resultListOf1Book = generateListOfNBooks(5);
            when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(resultListOf1Book);
            //When
            List<Book> listBooksOfUser = bookLibrary.listBooksInHandsOf(user);
            //Then
            Assertions.assertEquals(5, listBooksOfUser.size());
        }
    }
}
