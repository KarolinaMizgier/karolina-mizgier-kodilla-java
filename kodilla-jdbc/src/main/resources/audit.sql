...
BEGIN
    INSERT INTO BOOKS_AUD (EVENT_DATE, EVENT_TYPE, BOOK_ID, NEW_TITLE, NEW_PUBYEAR,
        ...
        VALUE(CURTIME(), "UPDATE", OLD.BOOK_ID, NEW.TITLE, NEW.PUBYEAR,
              NEW.BESTSELLER, NEW.TITLE, OLD.PUBYEAR, OLD.BESTSELLER);
END $$
DELIMITER ;

UPDATE BOOKS SET BOOKS.BESTSELLER = 1
WHERE BOOK_ID = 6;
COMMIT;
...
BEGIN
    INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, READER_ID, NEW_FIRSTNAME,
                             NEW_LASTNAME, NEW_PESEL, NEW_VIP_LEVEL)
...
VALUES (6, "Karolina", "Mizgier", "99999999999", "Standard customer");
COMMIT;
...
BEGIN
    INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, READER_ID, NEW_FIRSTNAME,
                             NEW_LASTNAME, NEW_PESEL, NEW_VIP_LEVEL, OLD_FIRSTNAME,
                             OLD_LASTNAME, OLD_PESEL, OLD_VIP_LEVEL)
...
UPDATE READERS SET READERS.VIP_LEVEL = "Gold customer"
WHERE READER_ID = 6;
COMMIT;
